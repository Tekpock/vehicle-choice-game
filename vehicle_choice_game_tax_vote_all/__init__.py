...
def set_payoffs(group: Group):
    ...
    for p in players:
        ...
        ### NOW WE RECORD IT INTO THE PARTICIPANTS FIELD
        if p.round_number == 1:
            p.participant.vars['payoff_round1'] = p.payoff
        elif p.round_number == 2:
            p.participant.vars['payoff_round2'] = p.payoff
